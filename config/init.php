<?php
   ...
   if (!defined('GALLERY')) define('GALLERY', '/public/uplouds/gallery');
   if (!defined('IMG')) define('IMG', '/public/uplouds/single');
   ...
   //"http://laravelmain.ru/index.php"
   $allowed_hosts = 'http://laravelmain.ru/index.php';
